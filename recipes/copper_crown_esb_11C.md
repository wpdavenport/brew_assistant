...
- 0.23 oz (6.6 g) Gypsum (CaSO4)
- 0.19 oz (5.5 g) Calcium Chloride (CaCl2)
- 0.06 oz (1.7 g) Epsom Salt (MgSO4)
...
10. At 10 minutes left, add Invert Sugar No.2 + Whirlfloc.
11. Flameout: add Northdown and steep 10 minutes.
12. Chill to 64.4 F (18.0 C), transfer clear wort, oxygenate once (60-90 sec), pitch decanted starter slurry.

## FERMENTATION SCHEDULE
1. Day 0-3: hold 64.4 F (18.0 C).
2. Day 4-6: ramp to 67.1 F (19.5 C), gently rouse yeast once at start of Day 4.
3. Day 7-9: hold 68.0 F (20.0 C) for cleanup.
4. Day 8-9: forced VDK check required before crash decision.
...
- Late hop drift that pushes beer out of classic 11C balance.
